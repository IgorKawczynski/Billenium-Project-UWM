...
interface UserRepository extends JpaRepository<User, Long> {
    ...
    @Query(value = """
            SELECT new pl.uwm.projektzespolowy.models.user.UserBoardsDTO(CAST(b.id as string), b.title.title, CONCAT(b.creator.firstName,' ', b.creator.lastName), CAST(b.creator.id as string))
